...
_DIAGNOSTIC_KEYS = {
    ...
    "END_DATE_MATCH", "DATE_RANGE_VALIDATION", "DATE_CONTROLS_SETTLED", "COMPETENCE_FAILURE_REASON", "ACTUAL_START_DATE", "ACTUAL_END_DATE",
    "SEARCH_CONTROL_FOUND", "SEARCH_ACTIVATION_ATTEMPTED", "SEARCH_ACTIVATION_CONFIRMED", "SEARCH_RESULT_REFRESH_CONFIRMED", "SEARCH_PROOF_METHOD", "PRE_SEARCH_ROW_COUNT", "PRE_SEARCH_EMPTY_MARKER_PRESENT", "PRE_SEARCH_RESULT_FINGERPRINT", "REFRESHED_RESULT_EMPTY",
